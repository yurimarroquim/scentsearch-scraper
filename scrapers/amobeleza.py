...
class AmobelezaScraper(BaseScraper):
    store_name = "Amobeleza"
    store_slug = "amobeleza"
    base_url = "https://www.amobeleza.com.br"
            ...
            try:
                ...
                for item in items:
                    try:
                        ...
                        product_url = self.affiliate_url(f"{self.base_url}/{link_text}/p")
