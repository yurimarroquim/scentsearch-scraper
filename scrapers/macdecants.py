...
class MacDecantsScraper(BaseScraper):
    store_name = "Mac Decants"
    store_slug = "macdecants"
    base_url = "https://www.macdecants.com.br"
    ...
    def get_page(self, url, params=None):
        response = self.session.get(
            url, params=params, timeout=(5, 30), allow_redirects=True
        )
        ...
        while True:
            ...
            for item in items:
                link = item.select_one(
                    "a.item-name, a[class*='item-name'], h2 a, .js-item-name a"
                )
                product_url = ""
                name = ""
